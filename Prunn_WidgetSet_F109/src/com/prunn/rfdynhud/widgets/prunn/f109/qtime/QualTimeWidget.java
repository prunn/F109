package com.prunn.rfdynhud.widgets.prunn.f109.qtime;
...
public class QualTimeWidget extends Widget
{
    ...
    private final ImagePropertyWithTexture imgTimeBlack = new ImagePropertyWithTexture( "imgTimeBlack", "prunn/f109/qlaptime.png" );
    private final ImagePropertyWithTexture imgTimeGreen = new ImagePropertyWithTexture( "imgTimeGreen", "prunn/f109/gapgreen.png" );
    private final ImagePropertyWithTexture imgTimeYellow = new ImagePropertyWithTexture( "imgTimeYellow", "prunn/f109/gapyellow.png" );
    
    
    private final ColorProperty fontColor2 = new ColorProperty("fontColor2", PrunnWidgetSetF109.FONT_COLOR2_NAME);
    private final FontProperty posFont = new FontProperty("positionFont", PrunnWidgetSetF109.POS_FONT_NAME);
    private final ColorProperty gapFontColor1 = new ColorProperty("gapColor1", PrunnWidgetSetF109.GAP_FONT_COLOR1_NAME);
    private final ColorProperty gapFontColor2 = new ColorProperty("gapColor2", PrunnWidgetSetF109.GAP_FONT_COLOR2_NAME);
    ...
    protected void initialize( LiveGameData gameData, boolean isEditorMode, DrawnStringFactory drawnStringFactory, TextureImage2D texture, int width, int height )
    {
        ...
        imgPosFirst.updateSize( rowHeight *2, rowHeight *2, isEditorMode );
        imgPosOut.updateSize( rowHeight *2, rowHeight *2, isEditorMode );
        ...
        switch ( situation.getValue() )
        {
            case LAST_SECONDS_OF_SECTOR_1:
                ...
                if(leadercarinfos.getPlace( false ) == 1)
                    texture.clear( imgPosFromFirst.getTexture(), offsetX, offsetY + rowHeight*2, false, null );
                else
            ...
            case LAP_FINISHED_BEGIN_NEW_LAP:
                ...
                if(currentcarinfos.getPlace( false ) == 1)
                    texture.clear( imgPosFirst.getTexture(), offsetX + imgTime.getTexture().getWidth(), offsetY, false, null );
                else 
                    if(currentcarinfos.getPlace( false ) <= posKnockout.getValue())
                        ...
                        texture.clear( imgPosOut.getTexture(), offsetX + imgTime.getTexture().getWidth(), offsetY, false, null );
    ...
    protected void drawWidget( Clock clock, boolean needsCompleteRedraw, LiveGameData gameData, boolean isEditorMode, TextureImage2D texture, int offsetX, int offsetY, int width, int height )
    {
        ...
        {
            dsName.draw( offsetX, offsetY, currentcarinfos.getDriverName(), texture );
        }
    ...
    {
        super( PrunnWidgetSetF109.INSTANCE, PrunnWidgetSetF109.WIDGET_PACKAGE_F109, 30.0f, 17.1f );
