...
public class PrunnWidgetSetF109 extends WidgetSet
{
    /*
     *  @author Prunn
     * copyright@Prunn2011
     */
    private PrunnWidgetSetF109()
    {
        super( composeVersion( 1, 0, 0 ) );
    }
    public static final PrunnWidgetSetF109 INSTANCE = new PrunnWidgetSetF109();
    ...
    public static final WidgetPackage WIDGET_PACKAGE_F109 = new WidgetPackage( INSTANCE, "Prunn/F1 09", INSTANCE.getIcon( "com/prunn/rfdynhud/widgets/prunn/prunn.png" ), INSTANCE.getIcon( "com/prunn/rfdynhud/widgets/prunn/f109.png" ) );
    ...
    public static final String F109_FONT_NAME = "f109Font";
    public static final String POS_FONT_NAME = "PosFont";
    public static final String KNOCKOUT_FONT_COLOR = "KnockoutFontColor";
    ...
    public String getDefaultNamedColorValue( String name )
    {
        ...
        if ( name.equals( GAP_FONT_COLOR2_NAME ) )
            return ( "#050505" );
        if ( name.equals( KNOCKOUT_FONT_COLOR ) )
            return ( "#DA1C19" );
    ...
    public static String generateThreeLetterCode( String driverName )
    {
